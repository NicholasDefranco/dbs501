REM  Prepared by Nebojsa for PL/SQL course

REM  This script drops and then re-creates 7 tables from the HR schema
REM  Then  populates data into all 7 tables
REM  Finally creates one View
